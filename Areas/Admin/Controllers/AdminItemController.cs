...
namespace BurgerPlace.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class AdminItemController : Controller
    {
        ...
        {
            var appDbContext = _context.Item.Include(i => i.Categoria);
        ...
        public async Task<IActionResult> Create([Bind("ItemId,Nome,DescricaoCurta,DescricaoDetalhada,ImagemUrl,Preco,Ativo,Destaque,CategoriaId")] Item item)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categoria, "CategoriaId", "CategoriaId", item.CategoriaId);
            return View(item);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,Nome,DescricaoCurta,DescricaoDetalhada,ImagemUrl,Preco,Ativo,Destaque,CategoriaId")] Item item)
        {
            if (id != item.ItemId)
            {
                return NotFound();
